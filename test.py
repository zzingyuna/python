...
def getLinks(url):
	...
	try:
		bsObj = BeautifulSoup(html.read(), "html.parser")
		for link in bsObj.find("div",{"class","tplList tplJobList"}).findAll("a",href=re.compile("/Recruit/GI_Read/[0-9]+\?rPageCode=[A-Za-z]+")):
...
"""
getLinks("http://www.jobkorea.co.kr/recruit/joblist?menucode=local&local=I000")